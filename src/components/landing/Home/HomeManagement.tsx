...
const HomeManagement = ({ data }: { data: HomeSingleDetailsSection }) => {
  ...
  return (
    ...
    <section className="reader_ai sm:py-[80px] py-[50px] lg:px-[100px] px-[20px]">
      <div className="row">
        <div className='flex justify-center items-center flex-row bg_bg'
        style={{height: '70px'}}
        >
             <span className="!text-white" style={{top: '25px'}} > إدارة المؤسسات التعليمية </span>
        </div>
        <div className="mb-10">
        ...
        <div className="col-md-6">
          ...
          <div className="reader_ai_item shadow-sm bg-[#ffffff9e] px-[25px] py-[15px] h-[60px] rounded-[12px] flex justify-start items-center flex-row gap-3">
              ...
              <span className="text-third-color font-semibold text-[19px]"> إدارة المكتبات الرقمية </span>
            </div>
            <div className="reader_ai_item  shadow-sm bg-[#ffffff9e]  px-[25px] py-[15px] h-[60px] rounded-[12px] flex justify-start items-center flex-row gap-3">
              <div className="relative w-20 h-[60px]">
                <svg className="absolute inline-block translate-y-3 translate-x-2 w-20 h-[60px]" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <span className="text-third-color font-semibold text-[19px]"> تحرير المحتوى </span>
            </div>
            <div className="reader_ai_item shadow-sm bg-[#ffffff9e]  px-[25px] py-[15px] h-[60px] rounded-[12px] flex justify-start items-center flex-row gap-3"></div>
              <div className="relative w-20 h-[60px]">
                <svg className="absolute inline-block translate-y-3 translate-x-2 w-20 h-[60px]" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <span className="text-third-color font-semibold text-[19px]"> توزيع المحتوى  </span>
            </div>
            <div className="reader_ai_item shadow-sm bg-[#ffffff9e]  px-[25px] py-[15px] h-[60px] rounded-[12px] flex justify-start items-center flex-row gap-3">
              <div className="relative w-20 h-[60px]">
                <svg className="absolute inline-block translate-y-3 translate-x-2 w-20 h-[60px]" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <span className="text-third-color font-semibold text-[19px]"> مزامنة البيانات </span>
            </div>
            <div className="reader_ai_item shadow-sm bg-[#ffffff9e]  px-[25px] py-[15px] h-[60px] rounded-[12px] flex justify-start items-center flex-row gap-3">
              <div className="relative w-20 h-[60px]">
                <svg className="absolute inline-block translate-y-3 translate-x-2 w-20 h-[60px]" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <span className="text-third-color font-semibold text-[19px]"> لوحات تحكم تفاعلية  </span>
            </div>
            <div className="reader_ai_item shadow-sm bg-[#ffffff9e]  px-[25px] py-[15px] h-[60px] rounded-[12px] flex justify-start items-center flex-row gap-3">
              <div className="relative w-20 h-[60px]">
                <svg className="absolute inline-block translate-y-3 translate-x-2 w-20 h-[60px]" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <span className="text-third-color font-semibold text-[19px]"> تقارير الأداء </span>
            </div>
          </div>
      </div>
    </section>
