...
const HomeManagement = ({ data }: { data: HomeSingleDetailsSection }) => {
  ...
  return (
       ...
       <section className="reader_ai sm:py-[80px] pt-[50px] lg:px-[100px] px-[20px]">
      <div className="row">
        <div className='flex justify-center items-center flex-row bg_bg'
        style={{height: '70px'}}
        >
            <span className="" style={{top: '25px'}}> إدارة المؤسسات التعليمية </span>
        </div>
        <div className="mb-10">
        ...
        <div className="col-md-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-[30px]">
            <div className="reader_ai_item shadow-sm bg-[#fff] px-[25px] py-[15px] h-[60px] rounded-[12px] flex justify-start items-center flex-row gap-3">
